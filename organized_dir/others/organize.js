...
//     let doesorganizedFolderPathExist = fs.existsSync(organizeddirPath);
//     if (doesorganizedFolderPathExist == false){
//         fs.mkdirSync(organizeddirPath);
//     }

//     let names = fs.readFileSync(dirPath);
...
//     let ans = fs.lstat(assetPath).isFile();
//     return ans;
// }
...
//     fs.copyFileSync(originalName, "file copied to", type);
// }
